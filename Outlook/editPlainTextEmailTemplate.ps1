...
$file = "<folder path of the email template(.ost or .msg file)>" #The email file needs to be in Plain Text format
...
$msg.HTMLBody= $msg.Body.Replace("<Word or Words that you want to replace>","<Object that you want to replace it with>")
